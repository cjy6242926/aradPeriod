...
public class CodeGenerator {
	public static void main(String[] args) {
		...
		dsc.setUrl(
				"jdbc:mysql://115.29.179.134:3506/mysql01?characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&useSSL=true&serverTimezone=UTC");
		dsc.setDriverName("com.mysql.cj.jdbc.Driver");
		dsc.setUsername("root");
		dsc.setPassword("s19ew@A$sw");
		mpg.setDataSource(dsc);

		// 包设置
		PackageConfig pc = new PackageConfig();
		// pc.setModuleName(scanner("模块名"));
		pc.setParent("com.example.demo.web");//包名
		...
		strategy.setInclude("sys_user_role");//要操作的表
